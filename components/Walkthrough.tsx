...
const STEPS: Step[] = [
  ...
  { screen: "cockpit", target: '[data-tour="room"]', advance: "next",
    title: "The room",
    body: "Every seat's build so far, the seat on the clock pulsing, you in green. Click a seat for its roster. Below it: the last few picks, with tools to add an unknown pick or jump the counter when the real room disagrees." },
  { screen: "cockpit", target: '[data-tour="controls"] summary', advance: "next",
    title: "Strategy lives in the menu",
    body: "The app picks the evidence-backed strategy for your format on its own. The ⋯ menu holds the picker (Zero RB, Hero RB, Custom dials…) for the curious, plus the tour and draft controls." },
